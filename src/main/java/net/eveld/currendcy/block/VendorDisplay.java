...
public class VendorDisplay extends BlockWithEntity {
  ...
  public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
    ...
    if (world.isClient) {
      VendorDisplayEntity blockEntity = (VendorDisplayEntity) world.getBlockEntity(pos);
      ItemStack items = blockEntity.getItemStack();
      player.sendMessage(new LiteralText(items.getItem().getTranslationKey() + " = " + items.getItem().getClass().getSimpleName()), false);
    }
